...
from attentions import TransformerTemporalModel
...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        if self.gradient_checkpointing:
            sample = transformer_g_c(self.transformer_in, sample, num_frames,bbx)
        else:
            sample = self.transformer_in(sample, num_frames=num_frames,bbx=bbx).sample
